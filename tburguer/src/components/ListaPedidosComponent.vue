<template>
  ...
  <MensagemComponent :msg="msg"/>
    ...
    <div>
      <div id="pedidos-tabela-cabecalho" v-show="listaPedidosRealizados.length === 0">
     ...
     <!-- Quando não tiver nenhum pedido, somente o o componente de msg é exibido falando que . -->
     <MensagemComponent v-show="listaPedidosRealizados.length === 0" :msg="msgErro"/>
...
export default {
  ...
  data() {
    return {
      ...
      listaStatusPedido: [],
      msg: null,
      msgErro: "NENHUM PEDIDO FOI CRIADO!"
    };
  },
  methods: {
